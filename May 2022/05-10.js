...
function shark(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin){
    ...
    if (sharkSwim(sharkDistance, sharkSpeed, dolphin) > youSwim(pontoonDistance, youSpeed)){
      return 'Alive!'
    }
    else if(sharkSwim(sharkDistance, sharkSpeed, dolphin) < youSwim(pontoonDistance, youSpeed)){
      return 'Shark Bait!'
    }
   }
   
function sharkSwim(distance, speed, dolphin){
    if(dolphin === true){
    let speedS = speed / 2
...
function youSwim(distance, speed){
 return distance / speed
}
